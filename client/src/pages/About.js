        ...
        <div className="container mx-auto px-4 min-w-[50px] w-full">
          ...
          <div className="bg-white p-8 rounded-lg shadow-lg mb-12">
            ...
            <p className="text-lg text-gray-700 leading-relaxed mb-6">
               Computer Shop offers a wide range of services and products to cater to all your computer needs:
            </p>
            <ul className="list-disc pl-5 space-y-2 text-gray-700">
          ...
          <div className="bg-secondary p-8 rounded-lg shadow-lg text-third text-center">
            <h2 className="text-2xl font-semibold mb-4">Join the  Family</h2>
            <p className="text-lg leading-relaxed mb-6">
              Whether you're looking for a new custom build or need help upgrading your current setup,  Computer Shop is your go-to destination. Visit us today or contact us to learn more about how we can help you achieve your tech goals.
            </p>
