    ...
    return (
        <div className="bg-gray-100 py-16">
            <div className="container mx-auto px-4">
                <h1 className="text-4xl font-bold text-center text-black mb-12">Contact Computer Shop</h1>
                <div className="bg-white p-6 rounded-lg shadow-lg mb-12">
                    <p className="text-lg text-gray-700 text-center leading-relaxed">
                        Have any questions or need assistance with your tech? Get in touch with the experts at{' '}
                        <span className="font-bold text-black">Computer Shop</span>. We are here to help you with custom PC builds, repairs, upgrades, and more. Reach out using the form below or visit us at our store.
                    </p>
                </div>
