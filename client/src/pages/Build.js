...
import { steps, componentOptions } from '../store/store';
...
function ComputerConfigurator() {
  ...
  const generatePDF = () => {
    ...
    doc.text('Website: www.shop.in', 10, 50);
  ...
  return (
    <div className="flex flex-wrap justify-center">
          ...
          <div key={index} className="bg-gray-100 rounded-lg shadow-md p-4 flex items-center space-x-4">
            ...
            <div className="flex-1">
              ...
              <button
                ...
                className={`w-full mt-2 p-2 text-white rounded-lg ${selectedItems[index] ? 'bg-black' : 'bg-red-600'} `}
              >
      ...
      <div className="w-full md:w-[45%] bg-fourth/20 p-4 space-y-4 rounded-lg mt-4 mb-3">
        ...
        <button
          onClick={generatePDF}
          className="w-full bg-red-600 text-white p-2 mt-4 rounded hover:font-semibold"
        >
          Download PDF
        </button>
